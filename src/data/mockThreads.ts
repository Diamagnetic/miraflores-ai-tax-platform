    ...
    messages: [
      {
        ...
        actionRequest: {
          ...
          isCompleted: true,
          responsePayload: 'Uploaded Sony lens and SD card receipts ($2,450)',
        },
      },
      {
        id: 'msg-p-2',
        ...
        content: 'Uploaded all B&H Photo receipts ($2,450 total) for the Sony telephoto lens and high-speed SD cards. Expense log attached!',
        isInternalFirmOnly: false,
      },
      {
        id: 'msg-p-3',
        ...
        content: 'Verified freelance photography expense log ($2,450) against Schedule C Line 9 deductions. Documentation matches IRS requirements.',
        isInternalFirmOnly: true,
      },
    ],
  },
